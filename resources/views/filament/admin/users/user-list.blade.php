        ...
        <div class="mx-auto max-w-7xl space-y-6">
            <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div class="space-y-2">
                    ...
                    <div>
                        <h1 class="text-2xl md:text-3xl font-semibold text-red-600">Usuarios del sistema</h1>
                        <p class="text-sm text-slate-600">Excluye tenderos. Usa el rol y estado para administrarlos.</p>
                    </div>
                </div>
